...
from common.common import read_tsv_to_tuples, build_vocab, KanjiHiraganaDataset
from char_level_LSTM.char_level_LSTM import Encoder, Decoder, LSTMSeq2Seq, train_model, predict
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--path', type=str, default='./char_level_LSTM/checkpoints/best_model.pt',
